...
<template>
  ...
  <br />
    <h3>Indirizzo di spedizione: {{ordinesingolo.value.shipping_address.street}}, {{ordinesingolo.value.shipping_address.number}} {{ordinesingolo.value.shipping_address.city}} {{ordinesingolo.value.shipping_address.CAP}}</h3>
    <br />
